...
def main(args):
    ...
    if args.recombine:
        if args.adjusted:
            save_dir = os.path.join(pairwise_event_save_dir,'recombine_adjusted')
        else:
            save_dir = os.path.join(pairwise_event_save_dir,'recombine')
    elif args.recombine_duration:
        if args.adjusted:
            save_dir = os.path.join(pairwise_event_save_dir,'recombine_duration_adjusted')
        else:
            save_dir = os.path.join(pairwise_event_save_dir,'recombine_duration')
